...
function checkNewPass(){
    let formElement = document.querySelector("#checkNewPass");
    let password = formElement.password;
    let gentagPassword = formElement.gentagPassword;
    if(password.value === ""){
        failtext("#passwordfail", "Du skal indtaste et password");
...
function checkImage(){
    let formElement = document.querySelector("#checkImage");
    let image = formElement.billede;

    if(image.value == false){
        failtext("#imagefail", "Vælg et billede");
        return false;
    }
}

//---------------CHECK POST PÅ PROFIL---------------
function checkpost(){
    let formElement = document.querySelector("#checkpost");
    let body = formElement.body;

    //Tjek post
    if(body.value === ""){
        failtext("#bodyfail", "Feltet er tomt");
        return false;
    }else{
        clear("#bodyfail");
    }
